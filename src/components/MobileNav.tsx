...
const MobileNav: React.FC<MobileNavProps> = ({ activeCategory, onCategoryClick }) => {
  ...
  return (
    <div className="sticky top-16 z-40 bg-black/95 backdrop-blur-sm border-b border-orange-500 md:hidden shadow-lg">
          ...
          <button
            ...
            className={`flex-shrink-0 flex items-center space-x-2 px-4 py-2 rounded-full mr-3 transition-all duration-200 ${
              activeCategory === category.id
                ...
                : 'bg-gray-800 text-gray-300 hover:bg-orange-900'
            }`}
          >
